...
<body id="top">
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">A.I & Blockchain - We leverage new technology to grow your business</h1>
            </div>
    ...
    <section id='services' class="s-services light-gray">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">We have everything you need to launch and grow a successful business.</h1>
            </div>
        </div> <!-- end section-header -->

        <div class="row" data-aos="fade-up">
            <div class="col-full">
                <!-- <p class="lead">Being a top web development company, we offer a top-notch pervasive wide range of creative web and mobile services,
                starting from analysis, project planning, design and development for memorable customer experience. Our expertise in
                delivering secure, interactive, innovative & robust business solutions has delighted 250+ customers in more than 15
                countries across the globe.  -->
                We pay attention to details :) Our professionals explore your business vision and offer an effective solution for your
                business.
                </p>
            </div>
        </div> <!-- end about-desc -->
        ...
        <div class="row services-list block-1-3 block-m-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h4">A.I Chatbots</h3>
                    <p>Now everyone can talk to your business and use your services from Facebook, Whatsapp, Slack, Web etc. Integrate natural language processing, data mining and pattern recognition in your app with our expertise
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Apps are redefining the way we interact with services and empowering businesses to engage with their customers
                        <ul>
                            <li>Android</li>
                            <li>iOS</li>
                            <li>UI/UX Design</li>
            ...
            <div class="masonry">
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <a href="https://liftndrop.com" class="item-folio__project-link" title="Project link">
                            Project Link
                        </a>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <a href="https://m.me/155102891199428" class="item-folio__project-link" title="Project link">
                            Project Link
                        </a>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <a href="http://matech.digital/" class="item-folio__project-link" title="Project link">
                            Project Link
                        </a>
                ...
                <div class="col-full testimonials__slider">
                    ...
                    <div class="testimonials__slide">
                        ...
                        <div class="testimonials__author">
                            Dare Ikeola
                            <span>Business Dev., D&D events</span>
                        </div>
                    </div> 
    ...
    <section id="stats" class="s-stats">
        ...
        <div class="row stats block-1-4 block-m-1-2 block-mob-full" data-aos="fade-up">
            ...
            <div class="col-block stats__col">
                <div class="stats__count">397</div>
    ...
    <section id="contact" class="s-contact">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1 display-1--light">Ready? Get in touch and let's make something great together.</h1>
            </div>
        </div> <!-- end section-header -->
